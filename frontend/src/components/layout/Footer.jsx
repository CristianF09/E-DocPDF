    ...
    <footer className="bg-background/50 border-t border-white/10 backdrop-blur-lg">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10">
          ...
          <div>
            <h4 className="font-semibold text-sm mb-5 text-foreground">Instrumente</h4>
            <ul className="space-y-3 text-sm text-muted-foreground">
              ...
              <li><Link to="/editor" className="hover:text-foreground transition-colors hover:pl-1 duration-300">Editare PDF</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-muted-foreground">
              ...
              <li><Link to="/contact" className="hover:text-foreground transition-colors hover:pl-1 duration-300">Contact</Link></li>
            </ul>
          </div>
